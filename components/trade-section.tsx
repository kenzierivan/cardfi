...
// Mock NFT data from other users (not the connected wallet)
const nfts = [
  {
    id: "1",
          ...
          <CardContent>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center mt-1">
                      <span className="text-xs text-muted-foreground">Owner: {nft.owner}</span>
            ...
            {filteredNfts.length === 0 && (
              <div className="text-center py-12">
                <p className="text-muted-foreground">No NFTs available for trading from other collectors.</p>
              </div>
            )}
          </CardContent>
        </Card>
